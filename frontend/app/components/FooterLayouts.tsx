...
export default function FooterSection() {
  ...
  // Sembunyikan footer di login & activate
      ...
      <div className="relative z-10 py-12">
        <div className='container mx-auto px-6'>
          <div className="text-center space-y-6">
            ...
            {/* Kondisi: jika halaman "/" tampil footer lengkap */}
            {pathname === "/" ? (
              <>
                {/* Logo/Brand */}
                <div className="mb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      <div className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-400 px-2 py-1 rounded-full">
                        ...
                        <span className="text-xs font-medium">v3.1.5</span>
                      </div>
            ...
            {/* Copyright (selalu muncul di semua halaman kecuali login & activate) */}
